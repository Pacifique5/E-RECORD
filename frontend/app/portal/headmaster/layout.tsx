...
const navigation = [
  ...
  },
  {
    ...
    href: "/portal/headmaster/fees",
    icon: DollarSign,
  },
  {
    name: "Expense Management",
    href: "/portal/headmaster/expenses",
    icon: FileText,
  },
  {
    name: "Budget Planning",
    href: "/portal/headmaster/budget",
    icon: BarChart2,
  },
  {
    name: "Staff Payroll",
    href: "/portal/headmaster/payroll",
    icon: Users2,
  },
  {
    name: "Inventory",
    href: "/portal/headmaster/inventory",
    icon: Package,
  },
  {
    name: "Financial Report",
    href: "/portal/headmaster/reports",
    icon: FileBarChart2,
  },
  {
    name: "Notifications",
    href: "/portal/headmaster/notifications",
    icon: Bell,
  },
  {
    name: "Settings",
    href: "/portal/headmaster/settings",
    icon: Settings,
  },
]

export default function HeadMasterLayout({ children }: { children: React.ReactNode }) {
