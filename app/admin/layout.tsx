...
const Sidebar = () => {
  ...
  const menuItems = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 4H10V12H4V4ZM14 4H20V8H14V4ZM4 16H10V20H4V16ZM14 12H20V20H14V12Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 21H21M3 18H21M6 18V13M10 18V13M14 18V13M18 18V13M21 10L12 3L3 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )
    },
    {
  ...
  return (
    <div className="w-80 min-h-screen bg-white shadow-lg fixed top-0 left-0 z-40 h-full">
      <div className="p-6 flex flex-col gap-2">
        <h1 className="text-xl font-semibold text-[#1A75FF]">E-Record</h1>
                ...
                <Link
                  ...
                  className={`flex items-center space-x-3 p-3 rounded-lg transition-colors ${
                    isActive
                      ...
                      : 'text-gray-600 hover:bg-blue-50 hover:text-[#1A75FF]'
                  }`}
                >
    ...
    <header className="flex items-center justify-between px-8 py-6 bg-white shadow-sm sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4 relative">
        <div className="relative">
          ...
          >
            {year}
            <svg className="inline ml-1" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5 7.5L10 12.5L15 7.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-24 bg-white border border-gray-200 rounded shadow-lg z-40">
              {years.map((y) => (
                <div
                  key={y}
                  className={`px-4 py-2 cursor-pointer hover:bg-blue-50 ${y === year ? 'bg-blue-100 font-semibold' : ''}`}
